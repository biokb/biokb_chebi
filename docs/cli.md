...
BioKb-ChEBI provides a command line interface (CLI) to import ChEBI data into a relational database, create RDF turtles from it, and import the turtles into a Neo4J graph database.
